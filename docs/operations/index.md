...
* [Mission-queue break-glass CLI](mission-cli.md) - Terminal commands (`make missions` / `make mission-rm`) to inspect and edit the SQLite mission store directly when the Telegram bridge is unresponsive.
