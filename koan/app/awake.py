...
# ---------------------------------------------------------------------------
# Chat context building — extracted to chat_context.py so the dedicated chat
# process shares the exact same builder (specs/007-chat-process/). Re-exported
# here under the historical private names for backward compatibility.
# ---------------------------------------------------------------------------

from app.chat_context import (  # noqa: E402
    _chat_context_cache,
    build_chat_prompt as _build_chat_prompt,
    load_cached_context as _load_cached_context,
    read_sections_cached as _read_sections_cached,
)
