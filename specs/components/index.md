...
* [Component Spec — MCP Server](mcp.md) - Defines Kōan's opt-in stdio MCP front-end, curated REST operation tools, destructive-tool gate, and shared OpenAPI HTTP client boundary.
