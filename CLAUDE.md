...
- **Core skills** live in `koan/skills/core/` (abort, add_project, ai, ask, audit, brainstorm, branches, cancel, changelog, chat, check, check_notifications, checkup, ci_check, claudemd, config_check, dead_code, deepplan, delete_project, doctor, done, email, explore, fix, focus, gh_request, gha_audit, idea, implement, inbox, incident, journal, language, list, live, logs, magic, mission, passive, plan, pr, priority, private_security_audit, profile, projects, quota, rebase, recreate, recurring, refactor, reflect, rename, restart, review, review_rebase, rtk, scaffold_skill, security_audit, shutdown, snapshot, sparring, squash, stats, status, tech_debt, verbose)
