...
- [`operations/log-formatting.md`](docs/operations/log-formatting.md) — Documents the display-side `[cli]` log formatter (log_fmt.py) behind `make logs`, its glyph legend, tick-collapse behavior, and the `raw=1` escape hatch.
