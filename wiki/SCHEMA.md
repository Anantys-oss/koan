...
roots) holding `SCHEMA.md`, `index.md`, plus three directory symlinks,
...
2. **`docs/index.md`, `specs/index.md`** — the OKF-conformant bundle-root catalog for
   ...
   `docs/SPEC.md` §5/§7). Mechanically generated by `scripts/okf_backfill.py indexes`,
...
- **Wiki bookkeeping is exempt from koan's human-in-the-loop discipline.** Frontmatter
  fields and `wiki/index.md` / `docs/index.md` / `specs/index.md` / per-folder `index.md`
  entries are committed directly as part of the same change/PR
