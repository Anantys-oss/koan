...
* [Skill Spec — commit](commit.md) - Specifies the `/commit` skill, which analyzes staged/unstaged git diffs and creates one local conventional commit without pushing, refusing protected base branches and secret files.
