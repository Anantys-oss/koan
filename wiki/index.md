...
- [`operations/maint.md`](docs/operations/maint.md) — Covers Kōan's release pipeline (incubate → incubating → release workflow), branch philosophy (`main` / `incubating` / `stable`), the curated changelog flow, versioning scheme, and recovery steps.
