...
Released versions of Kōan. Each section corresponds to a git tag cut by
`/koan.release`, which rolls the `## Unreleased` entries from
`changes/incubating.md` into this file. Newest release on top.
